...
make_fig(dat_df = dat, pred_df = pred_dat, res, height = 9, width = 4)
# # plot with only drivers of interest
make_fig(dat_df = dat, pred_df = pred_dat, sig_coeffs_list = res, height = 4, width = 4, filter.var.vec = c("bison1_mod", "n_grasshop_mod", "bison1.n_grasshop", "bison1:n_grasshop", "fri", "n_grasshop_previous", "years_since_last_burn"), fld = "./figs/5_mod-res-subset-primary.png")
# # plot with non-drivers of interest
make_fig(dat_df = dat, pred_df = pred_dat, sig_coeffs_list = res, height = 6.5, width = 4, filter.var.vec = c("bison1", "spei", "n_grasshop"), fld = "./figs/5_mod-res-subset-secondary.png")
